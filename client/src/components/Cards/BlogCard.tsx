...
const BlogCard = ({ blog }: { blog: iBlog }): JSX.Element => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-lg bg-natgas-azul text-center shadow-lg">
      ...
      <div className="px-6 py-4 text-gray-50">
        ...
        <hr />
        <p className="mt-5 mb-10 truncate text-justify font-quicksand-regular text-base text-gray-100">
          {content}
        </p>
