  ...
  return (
    <>
      ...
      <div className="mb-8 grid w-full justify-items-center pt-4" ref={topRef}>
        <button className=" h-[50px] w-[260px] rounded-full border-[5px] border-natgas-azul-claro font-bold text-natgas-azul">
          <div className="inline-flex">
            <p className="mt-0.5">Agregar Natgas Blog</p>
            <FaPlusCircle className="ml-4 text-3xl text-natgas-verde" />
          </div>
        </button>
      </div>
